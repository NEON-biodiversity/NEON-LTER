...
pm1<-lm(osbs_plant$ln.richness~osbs_plant$distance_m.building+
          osbs_plant$distance_m.roads+osbs_plant$distance_m.fire+
          osbs_plant$nlcdCls+
          osbs_plant$elevatn+
          osbs_plant$Freq)
summary(pm1)
anova(pm1)
#significant variables: landcover(nlcdCls)，fire frequency
...
pm2<-lm(osbs_plant$ln.richness~osbs_plant$distance_m.building+osbs_plant$distance_m.fire+
          osbs_plant$nlcdCls+
          osbs_plant$elevatn+
          osbs_plant$Freq)
summary(pm2)
...
#Reduced Model 4 - remove fire distance
...
#Reduced Model 5
pm6<-lm(osbs_plant$ln.richness~
          osbs_plant$nlcdCls)
summary(pm6)
#significant variables:  landcover(nlcdCls)

#Reduced Model 6
pm7<-lm(osbs_plant$ln.richness~
          osbs_plant$Freq)
summary(pm7)
#significant variables:  landcover(nlcdCls)，fire frequency
...
anova(pm1,pm7)  #p<0.01
anova(pm2, pm3) #Not Significant
anova(pm2, pm4) #Not Significant
anova(pm2, pm5) #Not Significant
anova(pm2,pm6)  #Not Significant
anova(pm2,pm7)  #p<0.01
anova(pm3, pm4) #Not Significant
anova(pm3, pm5) #Not Significant
anova(pm3,pm6)  #Not Significant
anova(pm3,pm7)  # p<0.001
anova(pm4, pm5) #Not Significant
anova(pm4,pm6)  #Not Significant
anova(pm4,pm7)  #p<0.001
anova(pm5,pm6)  #p=0
anova(pm5,pm7)  #p<0.001
anova(pm6,pm7)  #p<0.001
...
bm1<-lm(osbs_bird$ln.richness~
          ...
          osbs_bird$distance_m.roads+osbs_bird$distance_m.fire+
          osbs_bird$nlcdCls+
          osbs_bird$elevatn+
          osbs_bird$Freq)
summary(bm1)
...
mm1<-lm(osbs_mammal$ln.richness~
          ...
          osbs_mammal$distance_m.roads+osbs_mammal$distance_m.fire+
          osbs_mammal$nlcdCls+
          osbs_mammal$elevatn+
          osbs_mammal$Freq)
summary(mm1)
